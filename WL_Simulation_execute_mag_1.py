...
np.savetxt('w2_53_stack_simulation_mag_input_1.txt', mag_input)
np.savetxt('w2_53_stack_simulation_mag_output_sex_1.txt', mag_output_sex)
np.savetxt('w2_53_stack_simulation_mag_output_wayback_1.txt', mag_output_wayback)
np.savetxt('w2_53_stack_simulation_mag_output_error_sex_1.txt', mag_output_error_sex)
np.savetxt('w2_53_stack_simulation_mag_output_error_wayback_1.txt', mag_output_error_wayback)
np.savetxt('w2_53_stack_simulation_flux_input_1.txt', flux_input)
np.savetxt('w2_53_stack_simulation_flux_output_1.txt', flux_output)
np.savetxt('w2_53_stack_simulation_flux_output_error_1.txt', flux_output_error)
np.savetxt('w2_53_stack_simulation_flux_output_max_1.txt', flux_output_max)
np.savetxt('w2_53_stack_simulation_flux_output_max_error_1.txt', flux_output_max_error)
np.savetxt('w2_53_stack_simulation_number_lost_objects_1.txt', simulation.lost_objects)


np.savetxt('w2_53_stack_axis_param_1.txt', (simulation.mean_a, simulation.mean_b))
