        ...
        if compare == '1to2':
            ...
            for index in self.posible_obj_index_1:
                if index < len(self.positions_cat_1):
                    ...
                    f_1.write('%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s\t%-20s \n'% (cont, self.catalog_1[names[1]], self.catalog_1[names[2]], self.catalog_1[names[3]], self.catalog_1[names[4]], self.catalog_1[names[5]], self.catalog_1[names[6]], self.catalog_1[names[7]], self.catalog_1[names[8]], self.catalog_1[names[9]], self.catalog_1[names[10]], self.catalog_1[names[11]], self.catalog_1[names[12]], self.catalog_1[names[13]], self.catalog_1[names[14]], self.catalog_1[names[15]], self.catalog_1[names[16]], self.catalog_1[names[17]], self.catalog_1[names[18]], self.catalog_1[names[19]], self.catalog_1[names[20]], self.catalog_1[names[21]], self.catalog_1[names[22]], self.catalog_1[names[23]], self.catalog_1[names[24]], self.catalog_1[names[25]], self.catalog_1[names[26]], self.catalog_1[names[27]], self.catalog_1[names[28]]))
